        ...
        fetchAuthIsSuccess && (
          <Section className="">
            <Container className={"max-md:pt-12"}>
              <div className=" flex max-md:max-h-[calc(100dvh-4rem)] max-md:min-h-[calc(100dvh-4rem)] h-[calc(100dvh-2rem)] min-h-[95dvh] gap-x-8">
                  ...
                  <div className="flex h-full flex-col justify-stretch w-full">
                    ...
                    !languages ? (
                      ...
                      <div className="relative flex h-full flex-col justify-start ">
                        ...
                        <div className="flex flex-col justify-center relative max-lg:bottom-8 lg:bottom-4  pt-4 max-md:px-[0]  xl:px-[5rem] 2xl:px-[15rem] h-full  ">
                          <div className="pb-7 ">
                            ...
                            <h4 className="max-lg:text-md lg:text-lg text-slate-600 pb-8 md:pb-11">

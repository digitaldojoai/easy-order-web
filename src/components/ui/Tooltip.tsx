...
const Tooltip = ({
  ...
  const contentClass = classNames({
    "text-white bg-gray-800 text-xs px-3 py-1.5 rounded z-[10000] max-w-[200px] w-max bock break-words font-normal after:absolute after:block after:h-0 after:w-0 after:border-transparent after:z-[10000] [&[data-reference-hidden]]:hidden":
      true,
    "data-[placement=top]:after:top-full data-[placement=top]:after:left-1/2 data-[placement=top]:after:-translate-x-1/2 data-[placement=top]:after:border-t-gray-800 data-[placement=top]:after:border-t-6 data-[placement=top]:after:border-r-6 data-[placement=top]:after:border-b-0 data-[placement=top]:after:border-l-6":
      true,
